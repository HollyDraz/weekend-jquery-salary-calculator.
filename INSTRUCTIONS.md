...
-[x] create a function that then finds the sum of the employees that are in the table 
    -[x]show to total of the additon of all the employee salaries 
    -[x] note: its only going to add the salaries 
